  ...
  callMock(p1: any, p2: any): Observable<any> {
    return new Observable<any>(obs => {
      ...
      let plHttpRequest: PlHttpRequest = new PlHttpRequest({
                            url: environment.http.api.mock.url,
                            queryParams: Object({ api: "api", files: "files" }),
                            body: Object({ api: p1, files: p2 }),
                            httpHeaders: null,
                            method: environment.http.api.mock.method,
                            mocked: environment.http.api.mock.mocked
                          });
